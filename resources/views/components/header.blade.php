...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Fada's</span>
        </a>
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                <div class="px-4 py-3">
                    @auth
                        ...
                        <div class="flex justify-center mt-5 w-full bg-blue-600 rounded hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600">
                            <a href="{{ route('logout') }}" class="py-2 text-sm text-white ">
                                Logout
                            </a>
                        </div>
                    @else
                        <div class="flex justify-center">
                            <img src="assets/googleremove.png" alt="google logo" class="h-8"> <!-- Added mb-2 for spacing -->
                        </div>
                        <div class="flex flex-col items-center justify-center mt-2 w-full bg-blue-600 rounded hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600">
                            <a href="{{ url('auth/google') }}" class="py-2 text-sm text-white">
                                Login with Google
                            </a>
                        </div>
                    @endauth

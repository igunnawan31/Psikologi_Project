...
<body>
    ...
    <div class="container-mx-auto">
      <a href="/createyourown/pickyourtemplates" class="group block m-10 max-w-sm mx-auto rounded-lg p-6 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 border-dashed border-2 border-pink-300 hover: bg-gradient-to-b from-[#C0E9ED80] to-[#FBB6C880] hover:ring-pink-400 hover:border-none">

    ...
    <section id="Home" class="pt-36 pb-36">
        <div class="container mx-auto">
            <div class="flex justify-center items-center text-center">
                <h2 class="text-6xl mx-auto font-bold h-20 bg-gradient-to-b from-[#A47EFD] to-[#FF88E6] text-transparent bg-clip-text  ">
        ...
        <div class="container mx-auto">
            @forelse($templates as $template)
                <div class="my-10 max-w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <a href="/ourproduct/{{ $template->namatemplate }}">
                        <img class="rounded-t-lg w-full h-80 object-cover" src="{{ asset($template->pathtemplate) }}" alt="{{ $template->namatemplate }}" />
                    </a>
                    <div class="p-5">
                        <a href="/ourproduct/{{ $template->namatemplate }}">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $template->namatemplate }}</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ $template->deskripsitemplate }}</p>
                        <a href="/ourproduct/{{ $template->namatemplate }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Read more

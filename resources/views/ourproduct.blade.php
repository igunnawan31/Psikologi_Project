    ...
    <section id="Home" class="pt-36 pb-36">
        <div class="container mx-auto">
            <div class="flex justify-center items-center text-center">
                <h2 class="text-5xl mx-auto font-bold h-20 bg-gradient-to-b from-[#A47EFD] to-[#FF88E6] text-transparent bg-clip-text  ">
    ...
    <section id="OurProduct" class="pt-36 pb-36 px-4 lg:px-8">
        <div class="container mx-auto">
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="rounded-t-lg" src="public/assets/HappyBirthday.jpg" alt="Birthday Image" />
                </a>
                <div class="p-5">
                    <a href="#">
